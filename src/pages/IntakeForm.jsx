...
const STATIC_QUESTIONS = [
    ...
    },
    {
        id: 'skinTone',
        title: 'لون بشرتك',
        subtitle: 'المودل التي ستعرض لك التصميم ستكون بلون مقارب لك',
        type: 'options',
        multiSelect: false,
        options: [
            'بشرة عاجية فاتحة',
    ...
    {
        id: 'bodyShape',
        title: 'شكل الجسم العام',
        subtitle: 'لنعرض التصميم على قوام مقارب لك',
        type: 'options',
        multiSelect: false,
        options: [
            'نحيف/رياضي',
    ...
    {
        id: 'hairStyle',
        title: 'نوع تغطية الرأس / الشعر',
        subtitle: 'لإكمال واقعية المودل',
        type: 'options',
        multiSelect: false,
        options: [
            'شعر طويل ناعم',
            'شعر طويل كيرلي/متعرج',
            'شعر قصير (بوي)',
            'محجبة (حجاب كلاسيك)',
            'محجبة (توربان)',
            'بدون عارضة (مانيكان خياطة)'
        ],
    },
    {
        id: "clothingType",
