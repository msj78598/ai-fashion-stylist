...
const STATIC_QUESTIONS = [
    ...
    },
    {
        ...
        options: ['فستان سهرة / زفاف (Gown/Dress)', 'عباية راقية (Abaya)', 'بدلة نسائية رسمية (Suit/Tuxedo)', 'طقم قطعتين (Two-Piece Set)'],
    },
    {
        id: 'occasion',
    ...
    },
    {
        ...
        options: [
            'فتحة V عميقة', 'ياقة قلب "Sweetheart"', 'ياقة مربعة',
            'ياقة عالية دائرية "High Neck"', 'ياقة بليزر رسمية "Lapel"', 'ياقة أوف شولدر مكشوفة'
        ],
    },
    {
        id: 'sleeves',
        ...
        options: [
            'أكمام طويلة ضيقة', 'أكمام واسعة كلوش', 'أكمام منفوخة "Puff"',
            'أكمام الكاب المتدلية', 'بدون أكمام (علاقات أو مكشوف)'
        ],
    },
    {
        id: 'fabricMaterial',
    ...
    },
    {
        ...
        multiSelect: false, // ⚠️ إغلاق التحديد المتعدد
        options: [
            'شك خرز وكريستال يدوي', 'دانتيل فرنسي', 'ريش طبيعي',
            'نقشة جكار مدمجة', 'تصميم نظيف كلاسيك بدون إضافات'
        ],
    },
    {
        id: 'colors',
        ...
        options: [
            'أسود', 'كحلي (نيلي)', 'عنابي', 'زيتي',
            'وردي ناعم', 'موف (لافندر)', 'بيج (نود)',
            'ذهبي', 'فضي ميتاليك', 'لؤلؤي (سكري)', 'أحمر'
        ],
    },
    {
        id: 'budget',
    ...
    const handleNext = () => {
        ...
        if (nextStep < questions.length) {
            ...
            const payload = {
                ...
                strictMode: answers['activeTrack']?.includes('اليدوي') || answers['activeTrack']?.includes('Manual') ? true : false
            };
